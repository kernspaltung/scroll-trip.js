...
function setupScroll() {
   ...
   console.log("\n\n\n\n\n\n\nset scrollstep, setup", scrollStep);
         ...
         scrollTotal < levelsInfo[i].start + levelsInfo[i].childrenWidth ) {
            ...
            if( currentLevelIndex == nextLevelIndex ) {
               ...
               // if( ! $('.level').eq(nextLevelIndex).hasClass('multi-children') && levelsInfo[nextLevelIndex].size <= $(window).width() ) {
                  ...
                  console.log("\n\n\n\n\n",travelDirection, "doneScrollingtrue", i);
            ...
            if (!scrollingHorizontalLevel) {
               ...
               if (!levelsInfo[currentLevelIndex].doneScrolling) {
                  ...
                  if (nextLevel.length > 0) {
                     ...
                     console.log("\n\n\n\n\n\n\nset scrollstep", scrollStep, "travel");
                  }
...
console.log("DO Increment! drag", scrollStep);
   ...
   $(window).on('mousewheel', function(event) {
      if (!gotMouseWheel) {
         ...
         isScrolling = setTimeout(function() {
            console.log("DO Increment scroll!", scrollStep);
